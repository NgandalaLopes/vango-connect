        ...
        <div className='feed__inputContainer'>
            <div className='feed__input'>
                ...
                <div className='feed__inputOptions'>
                    <InputOption Icon={ImageIcon} title='Photo' color='#35b8e0' />
                    <InputOption Icon={SubscriptionsIcon} title='Video' color='#f3547a' />
                    <InputOption Icon={EventNoteIcon} title='Event' color='#21d658' /> 
                    <InputOption Icon={CalendarViewDayIcon} title='Write article' color='#546dff' />
                </div>
        </div>
